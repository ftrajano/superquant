...
export async function createPreference(items, payer = null, backUrls = null) {
  try {
    const defaultBackUrls = {
      success: `${process.env.NEXTAUTH_URL}/pagamento/pendente`,
    ...
    const body = {
      ...
      // REMOVIDO auto_return para evitar redirecionamento automático vulnerável
      // A ativação da assinatura deve acontecer APENAS via webhook seguro
