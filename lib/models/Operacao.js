...
const OperacaoSchema = new mongoose.Schema({
  ...
  quantidadeOriginal: {
    type: Number,
    default: null // Para rastrear a quantidade original em fechamentos parciais
  },
  valorTotal: {
    type: Number,
    default: function() {
...
// Use 'operacaos' como nome da coleção para manter compatibilidade com dados existentes
export default mongoose.models.Operacao || mongoose.model('Operacao', OperacaoSchema, 'operacaos');